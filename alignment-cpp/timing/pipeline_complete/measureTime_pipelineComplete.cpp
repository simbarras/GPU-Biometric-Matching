...
int main () {
    ...
    std::cout << "Complete pipeline timing done for:" << std::endl;
    ...
    for (auto it = files.begin(); it != files.end(); it++) {
        ...
        for (int i = 0; i < 15; i++) {
                    ...
                    nc::NdArray<bool> model = run_pipeline(width, height, (camPersp - '0'), &image, nullptr);
        ...
        std::cout << fileNameShort << std::endl;
