 ...
 * four bytes the number of non-zeros values of the second vein image, and in
 * the remaining memory the computed fingervein images.
...
bool compare_model_with_input(const int width, const int height,
                              ...
                              uint8_t *imageIn2, uint8_t *modelIn,
