...
This project also contains a testing and benchmarking infrastructure which can be accessed by executing the respective binaries generated by `CMakeLists.txt`. Execute any of the following lines to run the respective testing and/or benchmarking binary:
