 ...
 * @param[in] numNonZerosModel: A uint32_t denoting the number of non-zero values 
 * in the extracted fingervein image of the model, i.e. how many pixels were 
 * part of a vein.
 * @param[in] numNonZerosProbe: A uint32_t denoting the number of non-zero values 
 * in the extracted fingervein image of the probe, i.e. how many pixels were 
 * part of a vein.
 * @returns A double denoting the distance between the two input images.
*/
